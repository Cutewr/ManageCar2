...
static constexpr auto qt_meta_stringdata_CLASSchargeENDCLASS = QtMocHelpers::stringData(
    "charge",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSchargeENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSchargeENDCLASS_t qt_meta_stringdata_CLASSchargeENDCLASS = {
    {
        QT_MOC_LITERAL(0, 6),  // "charge"
